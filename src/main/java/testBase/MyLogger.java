...
public class MyLogger {
    //https://www.youtube.com/watch?v=0JQekot_5V8&list=PL5fOKT7XR42OgLXmX8wYYhB7L0sN-uqpR&index=12
    private static Logger logger = LogManager.getLogger();

    //synchronized: only one thread can access this class at a time
