...
public class ActionEngine {
    ...
    // https://www.youtube.com/watch?v=Tv2U0oa0OMY&list=PL5fOKT7XR42OgLXmX8wYYhB7L0sN-uqpR&index=13

    //Customized sendkeys method-> To log sendkeys message for every occ.
    public void sendKeys_ctm(WebElement element,String fieldName,  String value){
        try {
            element.sendKeys(value);
            //log success msg in extent report
            ExtentFactory.getInstance().getExtent().log(Status.PASS, fieldName+"==> Ented value as: "+value);
        } catch (Exception e){
            //log failure msg in extent report
    ...
    public void click_ctm(WebElement element, String fieldName) {
        try {
            element.click();
    ...
    public void clear_ctm(WebElement element,String fieldName) {
        try {
            element.clear();
            Thread.sleep(250);
    ...
    //custom mouseHover
    public void moveToElement_ctm (WebElement element,String fieldName){
        try{
    ...
    public boolean isElementPresent_ctm(WebElement element,String fieldName){
        boolean flag = false;
        try {
    ...
    public void selectDropDownByVisibleText_ctm (WebElement element, String fieldName, String ddVisibleText) throws Throwable {
        try {
    ...
    public void selectDropDownByValue_ctm(WebElement element, String fieldName, String ddValue) throws Throwable {
        try {
            Select s = new Select(element);
    ...
    //String Asserts
    public void assertEqualsString_ctm (String expvalue, String actualValue, String locatorName) throws Throwable {
        try {
    ...
    public String getText_ctm(WebElement element, String fieldName) {
        String text = "";
        try {
